...
/**Ejercicio 1
En recursos humanos van a aplicar una pol�tica de aumento de sueldo, con arreglo a la siguiente regla. 
Crea dos array de enteros, uno para las comisiones y otro para los sueldos, con el mismo n�mero de elementos cada uno:
a. Si la comisi�n es cero, nos fijamos en el sueldo y
...
b. Si la comisi�n es > 0, nos fijamos en la comisi�n y
Si es menor de 2000 aumentamos el sueldo un 12%
Si est� comprendido entre 2000 y 10000 aumentamos el sueldo un 6%
Si es mayor no le aumentamos nada.
c. Informamos al final de
Cuanto ganaba al principio,
Qu� % de subida le corresponde
Cu�nto supone el aumento (cero si no es nada)
En cu�nto se le queda el sueldo.
